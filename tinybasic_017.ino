...
// v0.17: 2018-6-1 (Harm)
//      Added MIN A,B and MAX A,B that put the min or max of A and B into A
//      B can also be a constant (i.e. MIN K,-3123).
...
//      on top (most used abbreviate shorter).
...
//      Modify input command to accept an expression using getn()
